 ...
 * @node: pointer
 * @height: highest point of tree
 *
 * Return:Traversed heap
 */
...
/**
 * heapify - increases max binary heap
 * @root: binary heap pointer.
 */
...
/**
 * heap_extract - extracts root node, using pointer,
 * from a Max Binary Heap
 * @root: heap root pointer
 * Return: extracted node for success
 **/
